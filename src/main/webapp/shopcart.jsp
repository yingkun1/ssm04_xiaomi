    ...
    $(function () {
        $.ajax({
            ...
            success:function (data) {
                console.log(data);
                let goodsCart = data.data.goodsCart;
                for(let i = 0;i<goodsCart.length;i++){
                    ...
                    let img = $("<img>").attr("src",goodsCart[i].goodsImagesList[0].path);
                    col_img.append(img);
                    ...
                    let col_input = $("<input>").attr("type","text").val(goodsCart[i].buyCount);
                    let sub = $("<a>").attr("href","#").append($("<em>").addClass("glyphicon glyphicon-plus"));
                    col_num.append(add).append(col_input).append(sub);

                    let col_total = $("<div>").addClass("col-total").text(goodsCart[i].subtotal);
                    ...
                    list_item.append(col_check).append(col_img).append(col_name).append(col_price).append(col_num).append(col_total).append(operation).append(clear);
